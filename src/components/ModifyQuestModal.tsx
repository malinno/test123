...
const ModifyQuestModal = () => {
  ...
  return (
    <Modal title={'Add Quest'} isOpen={!!questModal}
           onClose={() => setQuestModal && setQuestModal(undefined)}
           body={(
              <div className="p-5 flex flex-col gap-3">
                <div className="flex gap-3 items-center">
                  <span className="w-1/4">TypeID</span>
                  <input className="border rounded flex-1 px-3 py-1" value={data.name} onInput={(e: any) => setData(prep => {
                    return {
                      ...prep,
                      name: e.target?.value
                    }
                ...
                <div className="flex gap-3 items-center">
                  ...
                  <select className="border rounded flex-1 px-3 py-1" value={data.dataType} onChange={(e: any) => setData(prep => {
                    return {
                      ...prep,
                ...
                <div className="flex gap-3 items-center">
                  ...
                  <input className="border rounded flex-1 px-3 py-1" value={data.description} onInput={(e: any) => setData(prep => {
                    return {
                      ...prep,
